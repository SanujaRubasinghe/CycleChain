...
//   useEffect(() => {
//     setCar(dummyCarData.find((car) => car._id === id));//find the individual car data
//   },[id])
...
//                       "Mirror"].map((item)=>(
//                         <li key={item} className='flex itmes-center text-gray-500'>
...
//              <p className='text-center text-sm'>No credit card required ro reserve</p>
...
//         </div>
//     </div>
//   ) : <Loader/> // Show Loader Component if car data is not available
// }
