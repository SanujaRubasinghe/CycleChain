...
export async function POST(request) {
    try {
        ...
        const reservationData = {
            ...
            status: data.status || "reserved" // Make sure status is valid
        };
        ...
        // Validate status
        const validStatuses = ["reserved", "in_progress", "completed", "pending", "active", "cancelled"];
...
export async function GET({params}) {
    ...
    try {
        ...
        const reservations = await Reservation.findOne({userId: userId});
