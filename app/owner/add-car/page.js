...
function AddCar() {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add New Bike" subTitle="Fill in details to list a new car for 
      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <p className='text-sm text-gray-500'>Upload a picture of the bike</p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type="text" placeholder='e.g. BMX , Bolt ...' required
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. city rider, urban glide...' required
            className='px-3 py-2 mt-1 border border-borderColor rounded-md
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Price Per Minute ({currency})</label>
        ...
        {/* Car Transmission, Fuel Type, Seting Capacity  */}
         <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
         ...
         <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g. A Best model E bike with powerfull battery' 
            required
            className='px-3 py-2 mt-1 border border-borderColor rounded-md
